...
?>
    ...
    <div class="row">
        <div class="col-lg-12 mt-4">
            <h1 class="page-header">Knowledge for your own benefit is useless.
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Date/Time -->
            <p class="blogDate"><i class="fa fa-clock-o"></i> Posted on July 26, 2019 at 9:00 PM</p>

            <hr>

            <!-- Preview Image -->
            <img class="gmd-2 img-fluid blogPostImg" src="blogimg/Knowledge.png" alt="">
