...
?>
    ...
    <div class="row">
        <div class="col-lg-12 mt-4">
            <h1 class="page-header">Learning is EXTREMELY BORING
                <br><small style="text-decoration: none;">by  Mykola Babiy
                </small>
            </h1>
        </div>
    </div>
